            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                	<ul>
                        ...
                        <li class="actives"><a href="<%=path %>/teacher/subjectQuery.jsp">搜索试题</a></li>
                    </ul>
                </li>
        ...
        <ul class="breadcrumbs">
         ...
         <div class="maincontent" style="">
            <div class="maincontentinner">
                ...
                <div class="widget">
            <h4 class="widgettitle">查询题目</h4>
            <div class="widgetcontent">
                <form class="stdform" action="querySubjectLike.action" method="post">               
                      
                            <label>试题题目:</label>
                            <span class="field"><input type="text"  name="subjectTitle"  class="input-xlarge" placeholder="请输入..." /></span>
